...
class DetailPage extends StatelessWidget {
  ...
  DetailPage(String restaurantId) {
    id = restaurantId;
  }
                            ...
                            builder: (context, provider, child){
                              return Container(
                                ...
                                decoration: BoxDecoration(
                                    color: (provider.isDarkTheme) ? darkPrimaryColor : Colors.white,
                                ...
                                child: Column(
                                    ...
                                    children: [
                                            ...
                                            children: [
                                              Column(
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    width: 200,
                                                    child: textBold(restaurant.name, 24)),
                                                  SizedBox(height: 2),
                                                  // Restaurant Category
                                                  Container(
                                                    height: 20,
                                      ...
                                      menusCard(
                                          context, drinks, 'images/drink.png'),
                                      SizedBox(
                                        height: 24,
                                      ),
                                      // Location
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            textLight(restaurant.description, 18,
